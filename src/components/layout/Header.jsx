...
const Header = () => {
   ...
   return (
      ...
      >
         ...
         {/* Mobile Menu */}
         <div
            className={`fixed inset-0 bg-black/95 backdrop-blur-3xl z-[90] flex items-center justify-center transition-all duration-500 ${
               isMenuOpen
                  ? 'opacity-100 visible'
         ...
         >
            ...
            <nav className="flex flex-col items-center gap-7 sm:gap-8 w-full max-w-sm px-8">
               ...
               {[
                  ...
                  <a
                     ...
                     href={`#${item
                        ...
                        .replace(/\s+/g, '-')}`}
                     onClick={closeMenu}
                     className={`text-2xl sm:text-3xl md:text-4xl font-black text-white/90 hover:text-white transition-all duration-500 transform ${
                        isMenuOpen
               ...
               <a
                  href="#waitlist"
                  onClick={closeMenu}
                  className={`mt-8 w-full text-center py-4 sm:py-5 rounded-2xl bg-brand-gradient text-white font-black text-lg sm:text-xl shadow-2xl shadow-brand-purple/30 transition-all duration-700 transform ${
                     isMenuOpen
                        ? 'translate-y-0 opacity-100'
                        : 'translate-y-10 opacity-0'
                  }`}
