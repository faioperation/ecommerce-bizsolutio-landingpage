               ...
               {[
                  ...
                  return (
                     <a
                        ...
                        href={`#${id}`}
                        onClick={closeMenu}
                        className={`text-2xl sm:text-3xl md:text-4xl font-black transition-all duration-500 transform ${isMenuOpen
                           ? 'translate-y-0 opacity-100'
                           : 'translate-y-10 opacity-0'
                           } ${isActive
                              ? 'text-brand-pink drop-shadow-[0_0_15px_rgba(236,72,153,0.6)]'
