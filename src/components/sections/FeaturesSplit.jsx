...
const FeaturesSplit = () => {
   const sellerFeatures = [
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="15" rx="2" ry="2" /><path d="M12 11v5l4-2.5z" /><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>, title: 'Live Selling Tools', desc: 'Engage, showcase and sell in real time.', color: 'text-brand-purple' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><path d="M3 6h18" /><path d="M13 10l-3 5h4l-3 5" /></svg>, title: 'Instant Checkout', desc: 'Viewers can buy without ever leaving the stream.', color: 'text-brand-blue' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="13" r="8" /><path d="M12 9v4l2 2" /><path d="M10 2h4" /></svg>, title: 'Product Drops', desc: 'Launch limited drops and create urgency.', color: 'text-brand-pink' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z" /><path d="M9 12h6" /><path d="M12 9v6" /></svg>, title: 'Vouchers & Offers', desc: 'Boost sales with coupons, bundles and rewards.', color: 'text-brand-purple' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 20V10" /><path d="M12 20V4" /><path d="M6 20v-6" /></svg>, title: 'Analytics Dashboard', desc: 'Track performance and optimize your results.', color: 'text-brand-blue' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>, title: 'Fan Clubs', desc: 'Build a loyal community that keeps coming back.', color: 'text-brand-pink' },
   ];

   const customerFeatures = [
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /><path d="M10 8l5 4-5 4V8z" /></svg>, title: 'Live Interaction', desc: 'Ask questions and get real-time answers.', color: 'text-brand-pink' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><path d="M3 6h18" /><path d="M9 13l2 2 4-4" /></svg>, title: 'Exclusive Deals', desc: 'Live-only offers, flash sales and special vouchers.', color: 'text-brand-purple' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="M9 12l2 2 4-4" /></svg>, title: 'Trusted Sellers', desc: 'Verified sellers and  quality you can trust.', color: 'text-brand-orange' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>, title: 'Entertainment + Shopping', desc: 'Fun, engaging and worth your time.', color: 'text-brand-pink' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="M9 12l2 2 4-4" /></svg>, title: 'Easy & Secure', desc: 'One-tap checkout with safe payments.', color: 'text-brand-purple' },
      { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg>, title: 'Never Miss Out', desc: 'Follow your favorites and get notified live.', color: 'text-brand-orange' },
   ];
      ...
      <section className="py-5 md:py-10 lg:py-15 bg-brand-purple/10 relative overflow-hidden">
         ...
         <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-20 lg:gap-28 items-center">
               ...
               <div
                  id="for-sellers"
                  className="relative group text-center lg:text-center"
               >
                  ...
                  <h2 className="text-[2rem] sm:text-4xl md:text-[2.75rem] xl:text-[3.25rem] font-bold leading-tight tracking-tight mb-4 md:mb-5 text-white">
                     Powerful Tools.<br />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-6 md:gap-x-8 gap-y-10 md:gap-y-12">
                     {sellerFeatures.map((f, i) => (
                        <div
                           key={i}
                           className="flex flex-col items-start text-left gap-3 md:gap-4 group/item transition-all duration-300 hover:-translate-y-1"
                        >
                           <div
               ...
               <div
                  id="for-customers"
                  className="relative group text-left lg:pl-10"
               >
                  ...
                  <div className="inline-block px-3 py-1.5 rounded-full bg-gradient-to-r from-brand-pink to-brand-orange text-white text-[0.7rem] sm:text-[0.75rem] font-bold tracking-widest mb-6 md:mb-8 shadow-[0_0_15px_rgba(236,72,153,0.2)]">
                     FOR CUSTOMERS
                  </div>
