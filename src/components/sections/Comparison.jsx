  ...
  const platforms = [
    {
      name: 'TikTok Live',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#00f2ea] drop-shadow-[0_0_8px_#ff0050]">
   ...
   <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 xl:gap-16 items-start">
         ...
         <div className="lg:col-span-3 lg:sticky lg:top-28 text-center lg:text-left">
            ...
            <h2 className="text-[2rem] sm:text-4xl md:text-5xl xl:text-[3.4rem] font-black leading-[1.05] tracking-tight text-white mb-8">
               Not Social Media
               <br />
               With Shopping
               <br />
         ...
         {/* Cards */}
         <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 md:gap-6">

            {platforms.map((platform, i) => (
               <div
                  key={i}
                  className={`relative rounded-[28px] md:rounded-[32px] p-6 md:p-7 transition-all duration-500 hover:-translate-y-2 flex flex-col h-full group ${
                     platform.type === 'vango'
               ...
               >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                     ...
                     <div className="flex items-center gap-3 mb-8 md:mb-10">
                        ...
                        <span
                           className={`font-black tracking-tight text-sm md:text-[0.95rem] ${
                              platform.type === 'vango'
                                 ? 'text-white'
                                 : 'text-white/80'
                           }`}
                     ...
                     {/* Points */}
                     <ul className="space-y-4 flex-grow mb-8 md:mb-10">
                        ...
                        {platform.points.map((point, idx) => (
                           ...
                           >
                              ...
                              <span className="text-[0.78rem] sm:text-[0.82rem] font-bold leading-relaxed text-white">
                                 {point}
                              </span>
                           </li>
                        ))}
                     ...
                     <div className="flex gap-1.5 mt-auto">
                        ...
                        {[...Array(5)].map((_, idx) => (
                           <svg
                              key={idx}
                              className={`w-4 h-4 md:w-[18px] md:h-[18px] transition-colors duration-500 ${
                                 idx < platform.rating
                                    ? platform.type === 'vango'
